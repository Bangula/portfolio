                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div id="section2" className="tabSection col s12">
                            ...
                            <div className='sectionDescription'>
                                <p className='center teal-text text-darken-4 skillDscr'>Definitely my favorite programming language. After acquiring basic knowledge of JavaScript language on Cluster Academy, I devoted myself to deep understanding of OOP JavaScript, as well as understanding and managing asynchronous JavaScript processes. I work with ECMAScript 6 standard, and technologies and tools such as AJAX, JSON, RestAPI...</p>
                            </div>
                        </div>
                        ...
                        <div id="section4" className="tabSection col s12">
                            ...
                            <div className='sectionDescription'>
                                <p className='center teal-text text-darken-4 skillDscr'>I found that Node JS is perfect for me, because i can write JavaScript on the server side. Isn't that great? I prefer to use Express and MongoDB for creating Node apps. All of them in combination with ReactJS (MERN Stack), are powerful tool for creating highly demanded web apps.</p>
                            </div>
                        </div>
                    </div>
                </div>
